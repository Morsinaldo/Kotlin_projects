...
class MainActivity : AppCompatActivity() {
    ...
    var openGalleryLancher : ActivityResultLauncher<Intent> = registerForActivityResult(ActivityResultContracts.StartActivityForResult()){
        result ->
        ...
        permissions.entries.forEach{
            ...
            if(isGranted){
                ...
                if(permissionName == Manifest.permission.READ_EXTERNAL_STORAGE)
                    Toast.makeText(this@MainActivity, "Oop you just denied the permission.", Toast.LENGTH_LONG).show()
            }
        }
    }
                ...
                try {
                    ...
                    runOnUiThread{
                        ...
                        if(result.isNotEmpty()){
                            ...
                            Toast.makeText(this@MainActivity, "File not saved successfully", Toast.LENGTH_LONG).show()
                        }
                    }
                }
                catch (e : Exception){
